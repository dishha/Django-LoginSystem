...
from .views import (Teacher_registration,Student_registration,student_details,student_list,student_update,student_delete,teacher_details,teacher_list,teacher_update,teacher_delete)
